  ...
  <Layout>
    ...
    <div className="Hero">
      ...
      <p>Complete courses about the best tools
         and design systems. Prototype and build
    ...
    <Section 
     ...
     components, Grid Css, animations, interactions, dynamic data
     with Contentfol and deploying your site with Netlify."
    />
